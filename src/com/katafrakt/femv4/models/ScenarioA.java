...
public abstract class ScenarioA extends Model {
	...
	public void setModel() {
		...
		n[2]=new Node(this, 1000, 0, "n3");
		n[3]=new Node(this, 1000, 200, "n4");

		n[4]=new Node(this, 2000, 0, "n5");
		n[5]=new Node(this, 2000, 200, "n6");

		n[6]=new Node(this, 3000, 0, "n7");
		n[7]=new Node(this, 3000, 200, "n8");
		
		n[8]=new Node(this, 4000, 0, "n9");
		n[9]=new Node(this, 4000, 200, "n10");
		
		n[10]=new Node(this, 5000, 0, "n11");
		n[11]=new Node(this, 5000, 200, "n12");
	...
	@Override
	protected abstract void modifyModel();
