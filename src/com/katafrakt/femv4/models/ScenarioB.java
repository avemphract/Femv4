...
public abstract class ScenarioB extends Model {
	public Element[] e;
	public Node[] n;
	Material m;
	@Override
	public void setModel() {
		...
		n[2]=new Node(this, 900, 0, "n3");
		n[3]=new Node(this, 1100, 200, "n4");
		n[4]=new Node(this, 1900, 0, "n5");
		n[5]=new Node(this, 2100, 200, "n6");
		
		n[6]=new Node(this, 2900, 0, "n7");
		n[7]=new Node(this, 3100, 200, "n8");

		n[8]=new Node(this, 3900, 0, "n9");
		n[9]=new Node(this, 4100, 200, "n10");

		n[10]=new Node(this, 4900, 0, "n11");
		n[11]=new Node(this, 5100, 200, "n12");
